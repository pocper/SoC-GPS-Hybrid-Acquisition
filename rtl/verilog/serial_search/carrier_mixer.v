...
input carrier_sign, carrier_mag;

output reg       mix_sign;
output reg [2:0] mix_mag;
...
//================================================================
// Mixer
assign mix_sign_d   = !(if_sign ^ carrier_sign);
assign mix_mag_d[0] = (!carrier_mag);
assign mix_mag_d[1] = (if_mag | carrier_mag);
assign mix_mag_d[2] = (if_mag & carrier_mag);
